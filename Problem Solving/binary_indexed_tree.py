...
if __name__ == '__main__':
    ...
    print('Prefix sum of first {} elements is {}'.format(13, bit.prefix_query(12)))
    print('Prefix sum of first {} elements is {}'.format(7, bit.prefix_query(6)))
